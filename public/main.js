...
"use strict";
document.body.innerHTML = "<ul>" + [1, 2, 3].map((function(n) {
  return n * 2;
})).map((function(n) {
  return ("<li>" + n + "</li>");
})).join("") + "</ul>";
